...
const formSchema = z.object({
  title: z
    ...
    .max(50)
    .refine((data) => !titleList.includes(data), {
...
const CreatePost = () => {
  ...
  const onSubmit = cache(async (formValues: z.infer<typeof formSchema>) => {
    ...
    <Dialog onOpenChange={setOpenDialog} open={opendDialog} defaultOpen>
      <DialogTrigger asChild>
        <DropdownMenuItem onSelect={(e) => e.preventDefault()}>
          <Button variant="ghost" onClick={() => setOpenDialog(true)} size="sm">
            New Post
          </Button>
        </DropdownMenuItem>
      </DialogTrigger>
